...
import com.redhat.repository.validator.impl.remoterepository.RemoteRepositoryCompareValidator;
...
public class TestRemoteRepositoryCompareValidator extends AbstractTest {
    ...
    public void shouldFindMissingArtifact() throws URISyntaxException, RemoteRepositoryCompareException {
        ...
        assertExpectedException(RemoteRepositoryCompareException.class, "Remote repository [http://repository.jboss.org/nexus/content/groups/public/] doesn't contain artifact http://repository.jboss.org/nexus/content/groups/public/com/acme/foo/1.0/foo-1.0.pom");
        assertExpectedException(RemoteRepositoryCompareException.class, "Remote repository [http://repository.jboss.org/nexus/content/groups/public/] doesn't contain artifact http://repository.jboss.org/nexus/content/groups/public/com/acme/foo/1.0/foo-1.0.jar");
    }
