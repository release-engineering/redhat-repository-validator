...
public class AppRunner {
    ...
    protected void runHelp(Options options) {
        ...
        String header = "redhat-repository-validator is a tool used to validate the internal consistency of a maven artifact repository.\n";
        ...
        formatter.printHelp("redhat-repository-validator", options, true);
